...
{
    [CustomPropertyDrawer(typeof(RSPadding))]
    public class RSPaddingPropertyDrawer : RSStyleComponentPropertyDrawer<RSPadding>
    {
        ...
        public override void OnGUI(Rect position)
        {
            ...
            if(EndSetUnsetField()){ value.any = newVal; } position.y += 20;
