...
public class MainUI : MonoBehaviour
{
    ...
    class UserDataSearchView : SearchView<string, UserData>
    {
        protected override VisualElement CreateItemVisual(UserData value)
        {
            ...
            RSTextElement nameElement = new RSTextElement(RSLocalization.GetText(SR.userData_name) + "：" + value.Name);
            RSTextElement majorElement = new RSTextElement(RSLocalization.GetText(SR.userData_major) + "：" + value.Major);
            RSTextElement skillsElement = new RSTextElement(RSLocalization.GetText(SR.userData_skills) + "：" + value.Skills);
